...
## 研究者のあるある問題 {background-color="#2C3E50"}
...
2. Rで解析（同じ）
3. Quarto でレポート作成
4. **`document_create_from_html()`** で完了！
5. 再現性？ **完璧！**
:::
::::
:::
...
## さらなる可能性 {background-color="#D35400"}

::: {style="font-size: 0.85em;"}
### 自動化の未来

::: {.incremental}
- **Shinyアプリ統合**: 「RSpaceにアップロード」ボタン
- **自動メタデータ収集**: 解析日時・ソフトウェアバージョン・ファイルパス
- **バッチ処理**: 大量のサンプルを一括アップロード
- **パイプライン統合**: Nextflow/Snakemakeとの連携
:::
:::
...
## コミュニティとエコシステム {background-color="#9B59B6"}

::: {style="font-size: 0.85em;"}
### オープンソースの力

- **GitHub**: <https://github.com/LACDR/rspacer>
- **CRAN**: 誰でも簡単にインストール可能
- **MIT License**: 自由に使用・改変可能
- **Documentation**: 詳細なビネット・例付き
...
## まとめ：rspacerの価値 {background-color="#2C3E50"}

::: {style="font-size: 0.85em;"}
### データ管理のパラダイムシフト

::: {.incremental}
1. **統合**: R解析とELNのシームレスな連携
2. **自動化**: 手作業を排除、エラーを削減
3. **再現性**: すべてがコード化、追跡可能
4. **FAIR**: データ管理のベストプラクティスを自然に実現
5. **採用促進**: 研究者が実際に使いたくなるELN
:::
:::
...
::: {.column width="50%"}
**リソース**
- 📖 論文: [lacdr.github.io/rspacer-manuscript](https://lacdr.github.io/rspacer-manuscript/)
...
`library(rspacer)` で、あなたの研究も次のレベルへ 🚀
:::
